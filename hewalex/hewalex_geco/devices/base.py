...
class BaseDevice:
    ...
    def readRegisters(self, ser, start, num, retries=3):
        ...
        for attempt in range(1, retries + 1):
            ...
            try:
                ...
                # Te kort/corrupt antwoord (bijv. door bus-ruis of een trage
                # reactie van de gateway) — opnieuw proberen voordat we
                # opgeven. Elke poging flusht de inputbuffer en stuurt het
                # verzoek opnieuw, zodat een half ontvangen bericht niet
                # blijft "hangen" voor de volgende poging.
                last_err = e
                continue
        raise last_err
